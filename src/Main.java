...
public class Main {
	...
	public static void main(String[] args) {
		// make a new empty "Study" playlist
		Playlist studyPlaylist = new Playlist("Study");
		
		// make "synth pop" playlist and add 2 song to it.
		...
		Song experimentalSong2 = new Song("Motivation", "Clamis Casino");
		...
		// Get the playlist name of the studyPlaylist "Study"
